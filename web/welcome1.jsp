  ...
  String pass = rs.getString("password");
     ...
     <div style="margin-left: 800px;">Click on logout to use above options
         <a href="logout.jsp">Logout</a>
               ...
               <div style="margin-left: 10px; padding-top: 50px; padding-bottom: 20px;">
...
<table border="2" align="left">
                <form action="bup.jsp" method="post">
<table border="2" align="left">
<tr><th >USER ID</th><th>NAME</th><th>A+</th><th>A-</th>
                    ...
                    <tr> 
                        <td ><input type="text" name="bid" value="<%out.println(bid);%>" size="3" readonly> </td>
                        <td><input type="text" name="bname" value="<%out.println(name);%>" size="15" > </td>
                        <td><input type="text" name="ap" value="<%out.println(ap);%>" size="3"> </td>
                        <td><input type="text" name="an" value="<%out.println(an);%>" size="3"> </td>
                        <td ><input type="text" name="bp" value="<%out.println(bp);%>" size="3"> </td>
                        <td ><input type="text" name="bn" value="<%out.println(bn);%>" size="3"> </td>
                        <td ><input type="text" name="abp" value="<%out.println(abp);%>" size="3"> </td>
                        <td ><input type="text" name="abn" value="<%out.println(abn);%>" size="3"> </td>
                        <td ><input type="text" name="op" value="<%out.println(op);%>" size="3"> </td>
                        <td ><input type="text" name="onn" value="<%out.println(onn);%>" size="3"> </td>
                        <td ><input type="text" name="mobile" value="<%out.println(mobile);%>" size="10"> </td>
                        <td ><input type="text" name="address" value="<%out.println(add);%>" size="15"> </td>
                        <td ><input type="text" name="city" value="<%out.println(city);%>" size="15"> </td>
                        <td ><input type="text" name="email" value="<%out.println(email);%>" size="15"> </td>
                        <td ><input type="text" name="password" value="<%out.println(pass);%>" size="10"> </td>
                    </tR>
