...
<div id="tooplate_middle_subpage">
        ...
        String city = request.getParameter("city");
           ...
           ResultSet rs = stmt.executeQuery("select * from bregister where city='"+city+"'");
         while(rs.next()){
             out.println(rs.getString("bname"));   out.println(rs.getString("bname"));
           if(bld.equals("ab+"))
               {
           out.println(rs.getString("abp"));
               }
             out.println(rs.getString("bname")+rs.getString("address")+rs.getString("email")+rs.getString("moblie"));
           ...
           <div style="background-color: #330D0D; color: #ffffff; margin-top: 20px;">
               ...
               <br/>
           <label>Blood Group :</label><%out.println(ap);%>
              <br/>
