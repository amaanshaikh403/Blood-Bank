<%-- 
    Document   : donor
    Created on : May 30, 2017, 9:45:28 AM
    Author     : nithin
--%>
...
<tr><th >USER ID</th><th>NAME</th><th>EMAIL</th><th>MOBILE</th>
                        <th >GENDER</th><th >AGE</th><th>BLOOD GROUP</th>
                        <th >LOCATION</th><th>PASSWORD</th><th>HINT</th>
                        <th >ANSWER</th>
                    </tr>
    <%
                        MyDb db = new MyDb();
...
+"<td>"+rs.getString(3)+"</td>"+"<td>"+rs.getString(4)+"</td>"+"<td >"+rs.getString(5)+"</td>"+"<td >"+rs.getString(6)+"</td>"
