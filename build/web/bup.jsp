...
<html>
  ...
  String pass =request.getParameter("password");
         ...
         stmt.executeUpdate("update bregister set bname='"+name+"',email='"+email+"',mobile='"+mobile+"',ap='"+ap+"',an='"+an+"',bp='"+bp+"',bn='"+bn+"',op='"+op+"',onn='"+onn+"',abp='"+abp+"',abn='"+abn+"',"
                 + "         address='"+add+"',password='"+pass+"' where bid='"+bid+"'");
