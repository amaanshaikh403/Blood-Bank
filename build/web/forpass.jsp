...
<div id="tooplate_middle_subpage">
                             <center>    <h1>Enter correct details</h1></center> 		
</div> <!-- end of middle -->
...
<form action="change.jsp" method="post">
    <pre>
          ...
          <label class="main"> Name: </label>         <input type="text" placeholder="username" name="dname" required>
    ...
    <option value="b">Blood Bank</option>    
          ...
          <label class="main">Hint question: </label>  <select  style="width: 145px;" name="qn"> 
                                            ...
                                            <option value="2">Nick name</option>
          ...
          <label class="main">answer: </label>         <input type="text" placeholder="answer" name="ans" required>
                   ...
                   <input type="submit" value="Submit" style="background: #30122b;
