...
padding: 20px;">
    <%      
           ...
           ResultSet rs = stmt.executeQuery("select distinct(location) from uregister" ); 
           
           %>

<form action="searchudoner.jsp" method="post">
<pre>
 Blood Group           <select  style="width: 145px;" name="bld">
...
while(rs.next())
        {
                out.println(" <option>"+rs.getString("location"));

            }
  %>                                            </select>


               <input type="submit" value="Search Donor"style="background: #30122b;
